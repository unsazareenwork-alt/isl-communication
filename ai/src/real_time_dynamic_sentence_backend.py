...
if not backend.login():
    print("ERROR: Backend login failed.")
    raise SystemExit

if not backend.create_meeting():
    print("ERROR: Meeting creation failed.")
    raise SystemExit
        ...
        if confidence >= CONFIDENCE_THRESHOLD:
            ...
            if (
                ...
                if accepted_sign != current_prediction:
                    ...
                    accepted_sign = current_prediction
                    ...
                    word = str(current_prediction).strip()

                    if word:

                        sentence_words.append(word)

                        # Keep sentence from growing forever
